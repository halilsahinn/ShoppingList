...
namespace Teleperformance.Final.Project.Persistance.Migrations
{
    ...
    [Migration("20220705073426_Initial1")]
            ...
            modelBuilder.Entity("Teleperformance.Final.Project.Domain.Category.CategoryEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 7, 5, 7, 34, 25, 813, DateTimeKind.Utc).AddTicks(2372),
                            Description = "",
                            IsActive = true
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 7, 5, 7, 34, 25, 813, DateTimeKind.Utc).AddTicks(2377),
                            Description = "",
                            IsActive = true
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 7, 5, 7, 34, 25, 813, DateTimeKind.Utc).AddTicks(2379),
                            Description = "",
                            IsActive = true
                        });
                });
            ...
            modelBuilder.Entity("Teleperformance.Final.Project.Domain.Product.ProductEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2022, 7, 5, 7, 34, 25, 813, DateTimeKind.Utc).AddTicks(2879),
                            Description = "",
                            IsActive = true,
                            ProductName = "Süt",
                            Unit = (byte)1
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2022, 7, 5, 7, 34, 25, 813, DateTimeKind.Utc).AddTicks(2882),
                            Description = "",
                            IsActive = true,
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2022, 7, 5, 7, 34, 25, 813, DateTimeKind.Utc).AddTicks(2883),
                            Description = "",
                            IsActive = true,
                            ProductName = "Gazoz",
                            Unit = (byte)3
